 ...
 * Generated for Laravel 5.5.19 on 2018-01-31.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Response {
         ...
         * @static 
         */ 
        public static function badRequest($errors, $code = 400)
        {
            return \Illuminate\Routing\ResponseFactory::badRequest($errors, $code);
        }
